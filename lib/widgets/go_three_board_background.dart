...
class _GoThreeBoardBackgroundState extends State<GoThreeBoardBackground> {
  ...
  void _buildBoard() {
    ...
    final reflectionA = three.Mesh(
      three.PlaneGeometry(3.8, 1.05),
      reflectionMaterial,
    )
      ..position.setValues(2.0, _boardTop + 0.047, -1.95)
      ..rotation.x = -math.pi / 2
      ..rotation.z = -0.33;
    final reflectionB = three.Mesh(
      three.PlaneGeometry(2.2, 0.70),
      reflectionMaterial,
    )
      ..position.setValues(2.7, _boardTop + 0.046, -2.55)
      ..rotation.x = -math.pi / 2
      ..rotation.z = -0.40;
    _root
      ..add(reflectionA)
