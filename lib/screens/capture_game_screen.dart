...
class _CaptureGamePlayScreenState extends State<CaptureGamePlayScreen> {
  ...
  Future<void> _saveGame(CaptureGameProvider provider) async {
    ...
    final record = GameRecord(
      ...
      markedMoveNumbers: _markedMoveNumbers.toList()..sort(),
      outcome: outcome,
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    for (final move in widget.record.markedMoveNumbers)
                      Padding(
                    ...
                    child: _DecoratedActionButton(
                      ...
                      onPressed: isAtStart
                          ...
                          : () => setState(() {
                                _index--;
                                if (_onlyMarked) {
                                  final prev = widget.record.markedMoveNumbers
                                      .where((m) => m <= _index)
                                      .toList();
                                  if (prev.isNotEmpty) _index = prev.last;
                                }
                              }),
                    ),
                  ),
                    ...
                    child: _DecoratedActionButton(
                      ...
                      onPressed: isAtEnd
                          ...
                          : () => setState(() {
                                _index++;
                                if (_onlyMarked) {
                                  final next = widget.record.markedMoveNumbers
                                      .where((m) => m >= _index)
                                      .toList();
