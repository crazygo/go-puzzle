// AI training suggestion Web Worker entry point.
//
// This file is compiled to a standalone JavaScript bundle that runs inside a
// browser DedicatedWorker. It must not import Flutter framework packages.
...
import 'package:go_puzzle/game/training_suggestion_entry.dart';
...
void main() {
  ...
  scope.onMessage.listen((MessageEvent event) {
    ...
    try {
      ...
      final suggestions = runTrainingSuggestions(params);
      scope.postMessage({
        'requestId': requestId,
